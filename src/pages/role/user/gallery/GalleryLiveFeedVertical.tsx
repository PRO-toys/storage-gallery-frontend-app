// src/pages/role/user/gallery/GalleryLiveFeedVertical.tsx
...
const DEFAULT_SHOW_QR = ((import.meta.env.VITE_GALLERY_LIVE_VERTICAL_SHOW_QR as string) || "OFF").toUpperCase() === "OFF";
      ...
      <div className="px-4 py-3 flex items-center justify-between max-w-4xl mx-auto w-full">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            {showTitle && (
              <div className="text-[11px] uppercase tracking-widest text-white/80">Live Feed (9:16)</div>
            )}
            {showEvent && (
