...
import CardShareFaceBook from '../../../../components/card/CardShareFaceBook';
import CardShareLine from '../../../../components/card/CardShareLine';
...
const GalleryOnePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4 py-10">
      ...
      {/* Social Share (LINE) */}
      {/* <CardShareLine
        eventCode={event_code || 'DEV'}
        qrcode={qrcode || 'A001'}
        fileName="RenderImage1.jpg"
        iconSizePx={56}
        className="mt-2"
        onAddClick={() =>
          sendEvent('add_friend_line', { event_category: 'Gallery' })
        }
      /> */}
