...
// ======================================================
// GalleryOnePage — with polling, queue gate, cache-busting, CardShareFaceBook,
...
import iconDownload from '../../../../assets/images/role/user/gallery/icon-download.png';
import iconFb from '../../../../assets/images/role/user/gallery/icon-fb.png';
...
const GalleryOnePage: React.FC = () => {
  ...
  // Share — Facebook
  // =======================
  const shareImageUrl = `${backendUrl}/storage/gallery/${event_code}/${qrcode}/RenderImage1.jpg?t=${cacheBust}`;
  const handleShareFacebook = () => {
    const shareTarget = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(
      shareImageUrl
    )}`;
  ...
  return (
    <div
      ...
      style={{
        // Background image shown without scaling; will crop to viewport
        backgroundImage: `url(${bgLiveFeed})`,
        backgroundSize: 'auto',
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat',
        backgroundAttachment: 'fixed',
        // optional fallback color behind image edges if image < viewport
        backgroundColor: '#000',
      }}
    >
      {/* ======================= */}
      {/* Header — Brand / Logo  */}
      {/* ======================= */}
      <img src={logoSocialhub} alt="SocialHub Logo" className="w-40 mb-6" />
      ...
      <button onClick={handleDownloadClick} className="hover:opacity-80">
        <img src={iconDownload} alt="Download" className="w-16" />
      </button>
      ...
      {/* Social Share*/}
      {/* ======================= */}
      <button onClick={handleShareFacebook} className="hover:opacity-80 mt-2" aria-label="Share on Facebook">
        <img src={iconFb} alt="Share on Facebook" className="w-14 h-14" />
      </button>
