// src/pages/module/comfyui/onex/ghibli/Page1.tsx
...
const Page1: React.FC = () => {
    const [prompt, setPrompt] = useState('Studio Ghibli, a girl under cherry blossom, big expressive eyes');
    ...
    const handleDownload = () => {
        if (imageUrl) {
            const ext = fileType.toLowerCase();
            downloadFile(imageUrl, `ghibli-image.${ext}`);
        }
    };
        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-6xl bg-white p-6 rounded-2xl shadow-lg flex gap-8">
                ...
                <div className="w-1/2 flex flex-col">
                    <h1 className="text-3xl font-bold mb-4">GHIBLI - Image to Image</h1>
                    <p className="text-gray-600 mb-4">
                        Upload a reference image and describe the Ghibli-style result you'd like to generate.
                    </p>
                    ...
                    <textarea
                        placeholder="Enter your Ghibli-style prompt..."
                        value={prompt}
                    ...
                    >
                        {loading ? 'Generating...' : 'Generate Ghibli Image'}
                    </button>
                </div>
