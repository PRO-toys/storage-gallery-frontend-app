// src/pages/module/comfyui/vista/image-to-image/Page1.tsx
...
const Page1: React.FC = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${config.URL_MODULE}/api/comfyui/vista/image-to-image`, {
                prompt_text: prompt,
                seed_mode: seedMode,
        ...
        <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-6xl bg-white p-6 rounded-2xl shadow-lg flex gap-8">
                ...
                <div className="w-1/2 flex flex-col">
                    <h1 className="text-3xl font-bold mb-4">VISTA - Image to Image</h1>
