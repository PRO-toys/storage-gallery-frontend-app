// src/components/card/CardShareSocial.tsx
// ======================================================
// ✅ CardShareSocial — Facebook share button card with OG meta support
// ======================================================
...
// Props definition
// =======================
export interface CardShareSocialProps {
  /**
...
// Component
// =======================
const CardShareSocial: React.FC<CardShareSocialProps> = memo(
...
export default CardShareSocial;
